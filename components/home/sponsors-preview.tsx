        ...
        <section className="py-16 md:py-24 bg-muted/30">
            <div className="container px-4 md:px-6">
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12 items-center opacity-70 grayscale transition-all hover:grayscale-0 hover:opacity-100">
                    ...
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="flex items-center justify-center p-6 border rounded-lg bg-background shadow-sm h-32">
                            <div className="flex flex-col items-center gap-2">
                                <Handshake className="h-8 w-8 text-muted-foreground" />
                                <span className="font-semibold text-muted-foreground">Sponsor {i}</span>
                            </div>
                        </div>
                    ))}
                </div>
